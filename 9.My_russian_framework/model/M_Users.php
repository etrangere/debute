...
{	
	...
	{	
		...
		$query = sprintf($t, mysqli_real_escape_string(Connect::$link,$login));
		$result = $this->msql->Select($query);
		return $result[0];
	}
	...
	{	
		...
		$query = sprintf($t, mysqli_real_escape_string(Connect::$link,$sid));
		$result = $this->msql->Select($query);
	...
	private function GetSid()
	{
		...
		if ($sid != null)
		{
			...
			$t = "sid = '%s'";
			$where = sprintf($t, mysqli_real_escape_string(Connect::$link,$sid));

 ...
 */
class Version20180730133602 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE genus ADD sub_family_id INT NOT NULL ');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE genus DROP sub_family_id');
    }
}

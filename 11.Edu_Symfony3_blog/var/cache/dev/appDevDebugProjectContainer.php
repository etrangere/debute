...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3xrlKnbxfl', 0, 'CMNkt1p++gybvHn5l-4dz6', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('aX-+bilbJ7', 0, 'CMNkt1p++gybvHn5l-4dz6', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('S3wpl+CSfd', 0, 'CMNkt1p++gybvHn5l-4dz6', (__DIR__.'/pools'), $a));
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = DoctrineORMEntityManager_0000000050ade0b8000000005e408fe7f269e54047d914835f3ebded26c1962d::staticProxyConstructor(
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5b82d432e75f96.81524176')), true);
...
class DoctrineORMEntityManager_0000000050ade0b8000000005e408fe7f269e54047d914835f3ebded26c1962d extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5b82d4345b8e7657684384 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5b82d4345b902940196515 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b82d4345b880861282205 = [
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'getConnection', array(), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->getConnection();
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'getMetadataFactory', array(), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->getMetadataFactory();
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'getExpressionBuilder', array(), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->getExpressionBuilder();
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'beginTransaction', array(), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->beginTransaction();
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'getCache', array(), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->getCache();
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'transactional', array('func' => $func), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->transactional($func);
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'commit', array(), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->commit();
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'rollback', array(), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->rollback();
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'getClassMetadata', array('className' => $className), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->getClassMetadata($className);
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'createQuery', array('dql' => $dql), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->createQuery($dql);
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'createNamedQuery', array('name' => $name), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->createNamedQuery($name);
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->createNativeQuery($sql, $rsm);
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->createNamedNativeQuery($name);
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'createQueryBuilder', array(), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->createQueryBuilder();
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'flush', array('entity' => $entity), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->flush($entity);
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->find($entityName, $id, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->getReference($entityName, $id);
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->getPartialReference($entityName, $identifier);
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'clear', array('entityName' => $entityName), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->clear($entityName);
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'close', array(), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->close();
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'persist', array('entity' => $entity), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->persist($entity);
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'remove', array('entity' => $entity), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->remove($entity);
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'refresh', array('entity' => $entity), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->refresh($entity);
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'detach', array('entity' => $entity), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->detach($entity);
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'merge', array('entity' => $entity), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->merge($entity);
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->copy($entity, $deep);
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->lock($entity, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'getRepository', array('entityName' => $entityName), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->getRepository($entityName);
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'contains', array('entity' => $entity), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->contains($entity);
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'getEventManager', array(), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->getEventManager();
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'getConfiguration', array(), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->getConfiguration();
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'isOpen', array(), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->isOpen();
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'getUnitOfWork', array(), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->getUnitOfWork();
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->getHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->newHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'getProxyFactory', array(), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->getProxyFactory();
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'initializeObject', array('obj' => $obj), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->initializeObject($obj);
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'getFilters', array(), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->getFilters();
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'isFiltersStateClean', array(), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->isFiltersStateClean();
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'hasFilters', array(), $this->initializer5b82d4345b902940196515);

        return $this->valueHolder5b82d4345b8e7657684384->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer5b82d4345b902940196515 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder5b82d4345b8e7657684384) {
            $reflection = $reflection ?: new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder5b82d4345b8e7657684384 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder5b82d4345b8e7657684384->__construct($conn, $config, $eventManager);
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, '__get', ['name' => $name], $this->initializer5b82d4345b902940196515);

        if (isset(self::$publicProperties5b82d4345b880861282205[$name])) {
            return $this->valueHolder5b82d4345b8e7657684384->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5b82d4345b8e7657684384;
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5b82d4345b902940196515);
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, '__isset', array('name' => $name), $this->initializer5b82d4345b902940196515);
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, '__unset', array('name' => $name), $this->initializer5b82d4345b902940196515);
    ...
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, '__clone', array(), $this->initializer5b82d4345b902940196515);

        $this->valueHolder5b82d4345b8e7657684384 = clone $this->valueHolder5b82d4345b8e7657684384;
    }

    public function __sleep()
    {
        $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, '__sleep', array(), $this->initializer5b82d4345b902940196515);

        return array('valueHolder5b82d4345b8e7657684384');
    }
    ...
    {
        $this->initializer5b82d4345b902940196515 = $initializer;
    }
    ...
    {
        return $this->initializer5b82d4345b902940196515;
    }
    ...
    {
        return $this->initializer5b82d4345b902940196515 && $this->initializer5b82d4345b902940196515->__invoke($this->valueHolder5b82d4345b8e7657684384, $this, 'initializeProxy', array(), $this->initializer5b82d4345b902940196515);
    }
    ...
    {
        return null !== $this->valueHolder5b82d4345b8e7657684384;
    }
    ...
    {
        return $this->valueHolder5b82d4345b8e7657684384;
    }

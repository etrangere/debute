...
class __TwigTemplate_fc96856ef68c5f2d9e137072153483ef8859c4cc892bca88eda431ca9232b5bb extends Twig_Template
{
    ...
    ";
        ...
        <div id=\"tree-details-container\">
            ...
            foreach ($context['_seq'] as $context["formName"] => $context["formData"]) {
                // line 198
                echo "                ";
                echo $context["__internal_76a3861a412c5e70c179d06f98218caa18da68902c27ed6b799073c7489cee3f"]->getform_tree_details($context["formName"], $context["formData"], $this->getAttribute($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "data", array()), "forms_by_hash", array()));
                echo "
            ";
            }
            $_parent = $context['_parent'];
...
{% macro form_tree_details(name, data, forms_by_hash) %}
    ...
    {% endfor %}
{% endmacro %}
", "WebProfilerBundle:Collector:form.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/debute/11.Edu_Symfony3_blog/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/form.html.twig");
    }
}

...
class Room extends \AppBundle\Entity\Room implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Room' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Room' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Room' . "\0" . 'floor', '' . "\0" . 'AppBundle\\Entity\\Room' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Room' . "\0" . 'typeo', '' . "\0" . 'AppBundle\\Entity\\Room' . "\0" . 'reservations'];
        }
    ...
    public function getTypeo()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTypeo', []);

        return parent::getTypeo();
    }

    /**
     * {@inheritDoc}
     */
    public function setTypeo($typeo)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTypeo', [$typeo]);

        return parent::setTypeo($typeo);
    }

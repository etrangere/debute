...
class __TwigTemplate_807bc642ccd3e7c6a6378936a5e751eec540b4ac6b3121aeb80beca3e70c0dac extends Twig_Template
{
    private $source;
    ...
    public function block_top_bar($context, array $blocks = [])
    {
        ...
        <h3>Welcome : ";
        // line 6
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["session_user"]) || array_key_exists("session_user", $context) ? $context["session_user"] : (function () { throw new Twig_Error_Runtime('Variable "session_user" does not exist.', 6, $this->source); })()), "email", []), "html", null, true);
        echo "</h3>
    </div>
";

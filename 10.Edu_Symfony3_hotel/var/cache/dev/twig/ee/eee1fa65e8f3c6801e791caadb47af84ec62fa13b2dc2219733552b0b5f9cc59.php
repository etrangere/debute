...
class __TwigTemplate_4a35301b60e8f6fb4fb70b9f948c0bb86befda442a4f166d09f91be5109fb683 extends Twig_Template
{
    private $source;
            ...
            <div class=\"row\" id=\"offer_table\">
                {% for room in rooms %}
                    <tr >
                        ...
                        <td><a class=\"button\"  href=\"{{ path(\"booking\",{'id_room' : room.id|number_format })}}\">CHOOSE</a></td>
                    </tr>
                {% endfor %}
            </div>
            </tbody>
